...
function workFunctionField(n: 1 | 2 | 3 | 4 | 5): FieldDef {
  return {
    ...
    help:
      n === 1
        ? "เลือกแล้วระบบจะแสดงรายชื่อหน้าจอ Softpro ที่เกี่ยวข้องให้ด้านล่าง — ถ้าไม่ครบตามที่ต้องการ ดูไฟล์เต็มจากปุ่ม “รายชื่อโค้ดหน้าจอ Softpro” ด้านบน หรือระบุเพิ่มเติมในหมายเหตุให้ IT ช่วยตรวจสอบ"
        : undefined,
  };
}
